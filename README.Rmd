...
* Rule: [`uncompress`](https://github.com/sylvainschmitt/generateMutations/blob/main/rules/uncompress.smk) & [`index`](https://github.com/sylvainschmitt/generateMutations/blob/main/rules/index.smk)
* Tools: `zcat` & [`samtools faidx`](http://www.htslib.org/doc/samtools-faidx.html)
...
```{r}
read_tsv("results/mutated_reference/mutation.tsv") %>% 
